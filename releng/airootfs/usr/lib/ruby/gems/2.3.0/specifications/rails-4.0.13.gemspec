...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<actionmailer>, ["= 4.0.13"])
      s.add_runtime_dependency(%q<railties>, ["= 4.0.13"])
      ...
      s.add_dependency(%q<actionmailer>, ["= 4.0.13"])
      s.add_dependency(%q<railties>, ["= 4.0.13"])
