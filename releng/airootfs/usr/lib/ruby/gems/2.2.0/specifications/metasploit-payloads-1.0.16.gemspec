# -*- encoding: utf-8 -*-
# stub: metasploit-payloads 1.0.16 ruby lib

Gem::Specification.new do |s|
  s.name = "metasploit-payloads"
  s.version = "1.0.16"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.require_paths = ["lib"]
  s.authors = ["OJ Reeves", "Tod Beardsley", "Chris Doughty", "Brent Cook"]
  ...
  s.date = "2015-10-30"
  s.description = "Compiled binaries for Metasploit's Meterpreter"
  s.email = ["oj@buffered.io", "tod_beardsley@rapid7.com", "chris_doughty@rapid7.com", "brent_cook@rapid7.com"]
  s.homepage = "http://www.metasploit.com"
  s.licenses = ["3-clause (or \"modified\") BSD"]
  s.rubygems_version = "2.4.5.1"
  s.summary = "This gem contains the compiled binaries required to make Meterpreter function, and eventually other payloads that require compiled binaries."
